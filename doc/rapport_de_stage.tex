	...
	\begin{document}
		...
		\begin{abstract}
			...
			Ce rapport détaille les étapes du développement de l'API, les outils utilisés et les solutions mises en œuvre pour permettre une DEVEX (Developer Experience) et une UX (User Experience) optimales de l’API.
		\end{abstract}
