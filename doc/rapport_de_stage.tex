...
\end{itemize}
	...
	\end{verbatim}
	\textbf{index.html} est alors généré : 
	\begin{figure}[h!]
		\centering
		\includegraphics[width=1\textwidth]{asset/redocly.png}
		\caption{Page générée par Redocly}
		\label{fig:redocly}
	\end{figure}
	\subsection{Déploiement de la page sur GitHub Pages}
	Le déploiement sur GitHub Pages permet d'héberger la documentation générée par Redocly de manière accessible en ligne. Cela permet à toute personne  de consulter facilement la documentation via une URL publique.
	
	A compléter quand ça sera fait.
